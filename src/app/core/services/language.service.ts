...
export class LanguageService {
  ...
  private readonly translations: Record<SupportedLanguage, Record<string, string>> = {
    en: {
      ...
      experience_value: '5 Years', location_value: 'Delhi, India (Open to Relocation)',
      about_title: 'About Me',
      about_p1: 'Senior Angular Frontend Developer with 5 years of experience building high-performance, scalable Single Page Applications using Angular (v2-18+), TypeScript, and modern frontend architectures for enterprise-grade systems.',
    ...
    hi: {
      ...
      contact_email: 'ईमेल', contact_phone: 'फोन', contact_experience: 'अनुभव', contact_company: 'कंपनी', contact_location: 'स्थान', experience_value: '5 वर्ष',
      company_value: 'टाटा कंसल्टेंसी सर्विसेज (TCS)',
      location_value: 'बेंगलुरु, भारत (स्थानांतरण के लिए तैयार)',
      about_title: 'मेरे बारे में',
      about_p1: 'मैं 5 वर्षों के अनुभव वाला सीनियर Angular फ्रंटएंड डेवलपर हूं, जिसने Angular (v2-18+), TypeScript और आधुनिक फ्रंटएंड आर्किटेक्चर का उपयोग करके high-performance और scalable SPA एप्लिकेशन बनाए हैं।',
    ...
    es: {
      ...
      location_value: 'Delhi, India (Abierto a reubicacion)',
    ...
    fr: {
      ...
      contact_email: 'E-mail', contact_phone: 'Telephone', contact_experience: 'Experience', contact_company: 'Entreprise', contact_location: 'Lieu', experience_value: '5 ans',
      location_value: 'Delhi, Inde (Mobilite possible)',
    ...
    de: {
      ...
      contact_email: 'E-Mail', contact_phone: 'Telefon', contact_experience: 'Erfahrung', contact_company: 'Unternehmen', contact_location: 'Standort', experience_value: '5 Jahre',
      location_value: 'Delhi, Indien (Umzug moglich)',
